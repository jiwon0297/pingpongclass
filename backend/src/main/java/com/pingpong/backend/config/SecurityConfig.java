...
import com.pingpong.backend.api.jwt.JwtAccessDeniedHandler;
import com.pingpong.backend.api.jwt.JwtAuthenticationEntryPoint;
...
//        web.ignoring().antMatchers("/v2/api-docs", "/swagger-resources/**", "/swagger-ui.html", "/webjars/**", "/swagger/**");
    ...
    protected void configure(HttpSecurity httpSecurity) throws Exception {
        httpSecurity
                ...
                .antMatchers("/items/**").hasRole("STUDENT")
//                .antMatchers("/teachers/**","/teachers").hasRole("TEACHER")
                .antMatchers("/admin/**","/excel/**").hasRole("ADMIN")
